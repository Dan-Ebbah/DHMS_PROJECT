...
public class QUEHospital implements Hospital {

    private static final int MY_UDP_PORT_1 = 11002;
    private static final int MY_UDP_PORT_2 = 11005;
    ...
    public QUEHospital() throws SocketException {
    ...
    public String bookAppointment(String patientID, String appointmentID, String appointmentType) {
        ...
        if (mtlHospital == null || sheHospital == null) {
            logStatus = "Failure";
    ...
    public String listAppointmentAvailability(String type) {
        ...
        Thread t2 = new Thread(() -> hospitalUtil.findAvailabilityInThisCity("QUE", availabilityList, type, appointments));
    ...
    public String getAppointmentsOfPatient(String patientID) {
        ...
        appointments.forEach((appointmentType, stringAppointmentDetailsHashMap) ->
                stringAppointmentDetailsHashMap.forEach((appointmentID, appointmentDetails) -> {
                    if (appointmentDetails.getPatientIDList().contains(patientID)) {
                        appointmentIdsOfPatient.computeIfAbsent("QUE", k -> new HashMap<>());
                        appointmentIdsOfPatient.get("QUE").computeIfAbsent(appointmentType, k -> new ArrayList<>());
                        appointmentIdsOfPatient.get("QUE").get(appointmentType).add(appointmentID);
                    }
                }));
        ...
        if (!appointmentIdsOfPatient.isEmpty()) {
            appointmentIdsOfPatient.get("QUE").forEach((type, idList) -> {
